...
export const ModulesConfigStep: React.FC<ModulesConfigStepProps> = ({
  ...
  return (
    <div className="bg-mars-itemBackground py-12 px-4 rounded-4xl shadow-xl w-full flex flex-col relative">
      <h2 className="text-center font-bold tracking-widest text-sm uppercase mb-12 text-mars-orange">
        Moduły
      </h2>

      <div className="flex justify-center gap-4 md:gap-10 w-full mb-8">
        <button
          onClick={onAddModule}
      ...
      <div className="text-mars-orange text-xs tracking-widest uppercase text-center mb-4 font-bold">
        Nazwa
      </div>

      <div className="bg-mars-line rounded-xl p-2 h-64 overflow-y-auto shadow-inner border border-mars-line/30 w-full">
