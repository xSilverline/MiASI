          ...
          >
            <div className="flex flex-col items-center">
              ...
              <input
                ...
                className="w-full bg-mars-line text-white px-4 py-3 rounded-xl text-center text-xs tracking-wide focus:outline-none focus:ring-1 focus:ring-mars-orange/40 transition-all font-medium shadow-inner"
                required
              />
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <input
                ...
                className="w-full bg-mars-line text-white px-4 py-3 rounded-xl text-center text-xs tracking-widest focus:outline-none focus:ring-1 focus:ring-mars-orange/40 transition-all font-medium shadow-inner"
                required
              />
            </div>
            <button
              type="submit"
              className=" hover:text-slate-200 text-gradient-mars font-bold text-lg py-3.5 px-10  self-center uppercase tracking-widest active:scale-95 cursor-pointer mt-16"
            >
              Zaloguj
            </button>
          </form>
