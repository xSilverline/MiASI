package miasi.backend.schedule.infrastructure.in.web;
...
import miasi.backend.schedule.infrastructure.in.web.dto.CreateScheduleRequest;
import miasi.backend.schedule.infrastructure.in.web.dto.GenerateScenarioRequest;
import miasi.backend.schedule.infrastructure.in.web.dto.ScenarioDraftResponse;
import miasi.backend.schedule.infrastructure.in.web.dto.ScheduleModuleStateChangeRequest;
import miasi.backend.schedule.infrastructure.in.web.dto.ScheduleResponse;
import miasi.backend.schedule.infrastructure.in.web.dto.ScheduleResponseMapper;
import miasi.backend.schedule.infrastructure.in.web.dto.ScheduledEventRequest;
import miasi.backend.schedule.infrastructure.in.web.dto.TimelineResponse;
...
public class ScheduleController {
  ...
  @Operation(
      ...
      description =
          "Pozwala ręcznie dodać event typu THREAT, SUPPLY_DELIVERY albo MODULE_STATE_CHANGE"
              + " do istniejącego harmonogramu.")
  ...
  @Operation(
      ...
      description =
          "Tworzy tymczasowy draft scenariusza zdarzeń dla planu misji. Zwrócony draftId"
              + " identyfikuje ten tymczasowy zestaw zdarzeń przed zatwierdzeniem go jako harmonogram.")
  ...
  @Operation(
      ...
      description =
          "draftId to identyfikator tymczasowego scenariusza wygenerowanego przez POST /api/schedule/scenario.")
  ...
  @Operation(description = "Poprawia event w tymczasowym drafcie scenariusza.")
  ...
  @Operation(description = "Zatwierdza draft scenariusza i tworzy z niego nowy harmonogram.")
  ...
  @Operation(description = "Zatwierdza draft scenariusza do istniejącego harmonogramu.")
