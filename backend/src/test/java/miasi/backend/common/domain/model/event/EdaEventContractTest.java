...
class EdaEventContractTest {
  ...
  void integrationEventsShouldNotDependOnSpring() {
    var classes =
        new ClassFileImporter()
            ...
            .importPackages("miasi.backend.common.domain.model.event");

    ArchRuleDefinition.noClasses()
        .that()
        .resideInAPackage("miasi.backend.common.domain.model.event..")
        .should()
        .dependOnClassesThat()
  ...
  private void assertEnvelope(
      miasi.backend.common.domain.model.event.EventEnvelope envelope, String aggregateId) {
