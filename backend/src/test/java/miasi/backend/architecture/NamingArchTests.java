...
public class NamingArchTests {
  ...
  static final ArchRule ServiceNaming =
      classes().that().areAnnotatedWith(Service.class).should().haveSimpleNameContaining("Service");

  @ArchTest()
  static final ArchRule InterfaceNaming =
      classes().that().areInterfaces().should().haveSimpleNameStartingWith("I");

  @ArchTest
  static final ArchRule EnumNaming =
      classes().that().areEnums().should().haveSimpleNameNotContaining("Enum");
}
